 ...
 * <p>
 * This class is intended to be used in assertion statements, similar to the way that Java native assertion
 * mechanism is used. However there is a difference: when a Java assertion fails, an AssertionError is thrown, which
