...
/**
 * <p>Tests for situations where InvokeMethodRule instances and their
 * parameters overlap each other.</p>
 */
public class OverlappingInvokeMethodRuleTestCase extends TestCase {
     ...
     */
    public OverlappingInvokeMethodRuleTestCase(String name) {
    ...
    public static Test suite() {
        return (new TestSuite(OverlappingInvokeMethodRuleTestCase.class));
    }
    ...
    public void testItem1() throws SAXException, IOException {
        ...
        digester.addInvokeMethod("root/item", "setItemId", 1);
        digester.addInvokeParamFromAttr("root/item", 0, "id");
        digester.addInvokeMethod("root/item", "setItemName", 1);
        digester.addInvokeParamFromBody("root/item", 0);
    ...
    public void testItem4() throws SAXException, IOException {
        ...
        digester.addInvokeMethod("root/item", "setItemId", 1);
        digester.addInvokeParamFromAttr("root/item/id", 0, "value");
        digester.addInvokeMethod("root/item", "setItemName", 1);
        digester.addInvokeParamFromAttr("root/item/name", 0, "value");
    ...
    public void testWildcard1() throws SAXException, IOException {
        ...
        digester.addInvokeMethod("*/box", "setId", 1);
        digester.addInvokeParamFromAttr("*/box", 0, "id");
    ...
    public void testWildcard2() throws SAXException, IOException {
        ...
        digester.addObjectCreate("*/box", Box.class);
        digester.addInvokeMethod("*/box", "setId", 1);
        digester.addInvokeParamFromBody("*/box", 0);
        digester.addSetNext("*/box", "addChild");
